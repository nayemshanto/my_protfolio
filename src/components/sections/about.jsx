...
const About = () => {
  ...
  return (
    <section id="about" className="mih-h-screen flex flex-col justify-center items-center py-20">
      <ScrollBar>
        <div className="max-w-4xl mx-auto px-4  ">
          ...
          <div className="rounded-lg p-8 border-white/10 border hover:-translate-y-1 transition-all hover:border-[#0463fa]/30">
          ...
          <div className="rounded-lg mt-4 p-8 border-white/10 border hover:-translate-y-1 hover:border-[#0463fa]/30 transition-all">
